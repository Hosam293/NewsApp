...
// Colors
const backGround=Color.fromRGBO(238, 240, 249, 1.0);
...
List<Color> newsColor =[red,orangeLight,yellow,orangeDark,blue,green,blue];
List<String> newsText =['business','entertainment','general','health','science','sports','technology'];
